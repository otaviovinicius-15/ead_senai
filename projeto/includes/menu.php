...
<body class="bg-gray-100 min-h-screen flex">
    <aside class="w-56 bg-gray-900 min-h-screen flex flex-col flex-shrink-0">
        ...
        <nav class="flex-1 p-3 space-y-1 pt-4">
            <a href="../telas/admin/index.html"   class="nav-link">📊 Dashboard</a>
            <a href="../telas/cursos.html"  class="nav-link">📚 Cursos</a>
            <a href="../telas/modulos.html" class="nav-link active">📦 Módulos</a>
            <a href="../telas/aulas.html"   class="nav-link">🎬 Aulas</a>
